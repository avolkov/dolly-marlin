...
#define STRING_CONFIG_H_AUTHOR "Alex Vokov / 2023-11-24"             // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29.0, -1.0, -2.41 }
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 10 // (minutes) EEPROM save interval during print
#endif

...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define SD_PROCEDURE_DEPTH 3               // Increase if you need more nested M32 calls
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  .005       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY .005       // (steps or mm) Steps or millimeter distance for each XY babystep
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    69  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT          100  // (seconds) Time limit before the nozzle is turned off for safety.

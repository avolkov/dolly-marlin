...
#define STRING_CONFIG_H_AUTHOR "(Alex Volkov, 2023-06-03)" // Who made the changes.
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_BED_HYSTERESIS          7  // (°C) Temperature proximity considered "close enough" to the target
#endif
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.57,  22.20 }
    #define DEFAULT_Ki_LIST {   0.61,   1.08 }
    #define DEFAULT_Kd_LIST { 75.97, 114.00 }
  #else
...
#define PREHEAT_3_FAN_SPEED     0 // Value from 0 to 25

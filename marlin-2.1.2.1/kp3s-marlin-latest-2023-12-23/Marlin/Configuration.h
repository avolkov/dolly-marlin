 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -19, 0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER - 43/2 // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  - 19/2 // Y point for Z homing

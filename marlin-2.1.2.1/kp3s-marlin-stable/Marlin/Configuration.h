...
#define STRING_CONFIG_H_AUTHOR "(Alex Volkov, 2023-11-24)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 13.30, 13.30 }
    #define DEFAULT_Ki_LIST {  1.01,  1.01 }
    #define DEFAULT_Kd_LIST { 43.68, 43.68 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 839 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -53, -23, 0 }
...
#define PROBE_OFFSET_XMIN -55   // (mm)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER - 28  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER - 12 // Y point for Z homing
